    ...
    <div>
      ...
      <div className="card fade-up" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
          <span style={{ fontSize: '0.75rem', fontWeight: 700, background: 'rgba(255,255,255,0.2)', padding: '3px 12px', borderRadius: 100, letterSpacing: '0.5px', textTransform: 'uppercase' }}>✦ Gemini · Groq · Claude</span>
        </div>
